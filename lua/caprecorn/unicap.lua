...
local arch_last_reg = {
  [M.arch.X86_16] = x86_const.UC_X86_REG_ENDING,
  [M.arch.X86_32] = x86_const.UC_X86_REG_ENDING,
  [M.arch.X86_64] = x86_const.UC_X86_REG_ENDING,
}
...
M.open = function(_arch, reg)
  ...
  reg.name = function(reg_id)
    return arch_reg[reg._arch][reg_id]
  end
